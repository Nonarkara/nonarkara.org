...
const CACHE_VERSION = 'non-2026-08-16-v4.37';
...
const SHELL = [
  ...
  '/fallingwater.js',               // Bear Run, 1935
  '/walk.js',                       // first-person movement
  '/daylight.js',                   // sun, weather, rain
  '/astronomy.js',                  // one clock for sun, moon, rise and set
  '/world.js',                      // procedural mountain horizon
